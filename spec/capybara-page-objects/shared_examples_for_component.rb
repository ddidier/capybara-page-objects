...
#
# @param [Class] component_class the actual class of the component
#
shared_examples 'a CapybaraPageObjects::Component' do

  # ------------------------------------------------------------------------------------------------ Node examples -----

  it_behaves_like 'a CapybaraPageObjects::Node' do
    let(:node_class) { component_class }
  end

  # --------------------
  describe '#source' do
    let(:component_instance) { component_class.new(source) }
    ...
    context 'when source is specified' do
      ...
      it 'returns the specified source' do
        component_instance.source.should eq(source)
      end
    end
    ...
    context 'when source is not specified' do
      ...
      it 'returns the Capybara current session' do
        component_instance.source.should eq(Capybara.current_session)
      end
    end
